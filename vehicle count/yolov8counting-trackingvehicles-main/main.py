...
#        print(row)
    ...
    cv2.line(frame,(271,cy1),(534,cy1),(24,145,69),1)
    cv2.putText(frame,('1line'),(274,318),cv2.FONT_HERSHEY_COMPLEX,0.8,(0,255,255),2)

    cv2.line(frame,(534,cy2),(915,cy2),(24,145,69),1)
    cv2.putText(frame,('2line'),(538,363),cv2.FONT_HERSHEY_COMPLEX,0.8,(0,255,255),2)
    d=(len(counter))
